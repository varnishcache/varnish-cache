...
Durations are defined by a number, and optionally an unit. The number
can include a fractional part, e.g. 1.5.  If the unit is not specified,
seconds is used. The supported units are:
